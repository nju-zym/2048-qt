...
// 生成C++代码
void generateCppCode(const std::array<uint16_t, 65536>& leftTable,
    ...
    std::cout << "C++代码已生成到文件: " << outputFile << std::endl;
}
...
int main() {
    ...
    // 生成C++代码
    generateCppCode(leftTable, rightTable, scoreTable, "BitBoardTables.cpp");
