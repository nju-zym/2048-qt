...
void Auto::initTables() {
    ...
    for (unsigned row = 0; row < 65536; ++row) {
        ...
        heur_score_table[row] = 200000.0f + 270.0f * empty + 700.0f * merges
                                - 47.0f * std::min(monotonicity_left, monotonicity_right) - 11.0f * sum;
...
static bool isGameOverBitBoard(BitBoard board) {
    // 如果有空格，游戏未结束
    if ((board & 0xf) == 0 || (board & 0xf0) == 0 || (board & 0xf'00) == 0 || (board & 0xf0'00) == 0
        || (board & 0xf'00'00) == 0 || (board & 0xf0'00'00) == 0 || (board & 0xf'00'00'00) == 0
        || (board & 0xf0'00'00'00) == 0 || (board & 0xf'00'00'00'00) == 0 || (board & 0xf0'00'00'00'00) == 0
        || (board & 0xf'00'00'00'00'00) == 0 || (board & 0xf0'00'00'00'00'00) == 0
        || (board & 0xf'00'00'00'00'00'00) == 0 || (board & 0xf0'00'00'00'00'00'00) == 0
        || (board & 0xf'00'00'00'00'00'00'00) == 0 || (board & 0xf0'00'00'00'00'00'00'00) == 0) {
        return false;
    }

    // 检查是否可以合并
    BitBoard row_mask = 0xFF'FFULL;
    for (int i = 0; i < 4; ++i) {
